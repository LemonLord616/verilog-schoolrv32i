...
(
    ...
    output reg [ 1:0] mem_write, // data write on mem_write (see sr_cpu.svh MW_... constants)
    ...
    begin
        ...
        casez ({ funct7, funct3, op })
            ...
            { `RVF7_ANY,  `RVF3_SB,   `RVOP_SB    } : begin mem_write = `MW_B; alu_src_b = `ALUB_IMM; end
            { `RVF7_ANY,  `RVF3_SH,   `RVOP_SH    } : begin mem_write = `MW_H; alu_src_b = `ALUB_IMM; end
